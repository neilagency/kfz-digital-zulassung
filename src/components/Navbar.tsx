              ...
              {NAV_LINKS.map((link) =>
                isAnmeldenLink(link) ? (
                  <div key={link.href} className="relative group">
                    <Link
                      href={link.href}
                      className={`flex items-center gap-1 text-[13px] font-medium transition-colors whitespace-nowrap hover:text-accent ${
                    ...
                    <div className="absolute left-0 top-full pt-4 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                      <div className="w-64 rounded-2xl bg-white shadow-xl border border-gray-100 p-2">
                        <Link
                          href={link.href}
                          className="block rounded-xl px-4 py-3 text-sm font-semibold text-gray-800 hover:bg-gray-50 hover:text-primary"
                        >
                          KFZ online anmelden
              ...
              isAnmeldenLink(link) ? (
                <div key={link.href} className="border-b border-gray-100 pb-2">
                  ...
                  <Link
                    href="/evb"
                    onClick={closeMenu}
                    className="block ml-4 text-sm text-gray-600 hover:text-primary font-medium py-2"
                  >
                    EVB
                  </Link>
                </div>

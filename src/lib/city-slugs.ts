...
export const CITY_ENTRIES = [
  ...
  ['Zwickau', 'zwickau'],
  ['Bochum', 'auto-online-abmelden-in-bochum'],
  ['Heilbronn', 'auto-online-abmelden-heilbronn'],
  ['Karlsbad', 'auto-online-abmelden-karlsbad'],
  ['Köln', 'kfz-online-abmelden-koeln'],
  ['Landshut', 'auto-online-abmelden-landshut'],
  ['Neuss', 'auto-online-abmelden-in-neuss'],
  ['Wuppertal', 'auto-online-abmelden-in-wuppertal'],
  ['Baden-Baden', 'auto-online-abmelden-baden-baden'],
  ['Bremen', 'kfz-online-abmelden-bremen'],
  ['Dortmund', 'kfz-online-abmelden-dortmund'],
  ['Pirna', 'kfz-zulassung-pirna'],
  ['Göppingen', 'kfz-zulassungsstelle-goeppingen'],
  ['Erfurt', 'zulassungsservice-erfurt'],
  ['Halle (Saale)', 'zulassungsservice-halle-saale'],
  ['Hannover', 'zulassungsservice-hannover'],
  ['Kiel', 'zulassungsservice-kiel'],
  ['Magdeburg', 'zulassungsservice-magdeburg'],
  ['Stuttgart', 'zulassungsservice-stuttgart'],
  ['Dresden', 'dresden-kfz-zulassungsstelle'],
  ['Essen', 'kfz-online-abmelden-essen'],

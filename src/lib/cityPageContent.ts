...
export const cityPageContentConfig = {
  ...
  intros: [
  "Auto online abmelden in {{city}} ist für viele in {{state}} der einfachere Weg, wenn die Abmeldung ohne Termin und ohne unnötige Wege vorbereitet werden soll.",
"Wer sein Auto online abmelden in {{city}} möchte, sucht meist eine klare digitale Lösung. Genau deshalb wird der Online-Weg in {{state}} immer häufiger genutzt.",
"In {{city}} entscheiden sich viele für Auto online abmelden, weil der Ablauf digital startet und sich besser in den Alltag einfügt als ein Termin vor Ort.",
"Auto online abmelden in {{city}} spart für viele Zeit und zusätzlichen Aufwand. Gerade in {{state}} wird der digitale Weg deshalb oft bevorzugt.",
"Wer in {{city}} nach Auto online abmelden sucht, möchte den Vorgang meist schnell, verständlich und ohne unnötige Wartezeit vorbereiten.",
"In {{city}} ist Auto online abmelden für viele die bequemere Alternative, wenn die zuständige Stelle {{behoerde_name}} nicht extra besucht werden soll.",
"Auto online abmelden in {{city}} ist besonders praktisch, wenn alle wichtigen Angaben direkt digital übermittelt werden sollen und der Weg zur Behörde entfällt.",
"Viele Menschen möchten ihr Auto online abmelden in {{city}}, ohne sich nach Öffnungszeiten oder Terminvergabe richten zu müssen. Genau hier zeigt der digitale Weg seine Stärke.",
"Wer Auto online abmelden in {{city}} möchte, kann den Ablauf bequem digital starten. Für viele in {{state}} ist das heute die modernere Lösung.",
"Auto online abmelden in {{city}} wird oft gesucht, wenn Verkauf, Stilllegung oder Fahrzeugwechsel anstehen und der Vorgang nicht unnötig Zeit kosten soll.",
"In {{city}} ist Auto online abmelden für viele besonders interessant, weil der Ablauf klar strukturiert ist und ohne zusätzlichen Vor-Ort-Termin vorbereitet werden kann.",
"Wer sein Fahrzeug online abmelden in {{city}} möchte, will meist keine komplizierten Schritte. Genau deshalb wird die digitale Abmeldung in {{state}} immer beliebter.",
"Auto online abmelden in {{city}} heißt für viele: weniger Wege, weniger Aufwand und ein verständlicher digitaler Start von zu Hause aus.",
"In {{city}} bevorzugen viele Fahrzeughalter Auto online abmelden, weil die wichtigsten Daten direkt digital erfasst und ohne Behördengang vorbereitet werden können.",
"Wer Auto online abmelden in {{city}} sucht, möchte meist wissen, wie der Ablauf funktioniert und was gebraucht wird. Genau das wird hier klar gezeigt.",
"Auto online abmelden in {{city}} ist für viele die bessere Lösung, wenn die Fahrt zu {{behoerde_name}} vermieden und der Vorgang bequem online begonnen werden soll.",
"In {{state}} suchen viele Nutzer nach Auto online abmelden in {{city}}, weil sie eine einfache, digitale und zeitsparende Möglichkeit zur Abmeldung möchten.",
"Wer in {{city}} sein Auto online abmelden möchte, möchte den Ablauf oft ohne Anfahrt und ohne Wartezimmer erledigen. Der digitale Weg passt dafür besonders gut.",
"Auto online abmelden in {{city}} ist für viele heute naheliegend, weil der Vorgang klar aufgebaut ist und sich besser planen lässt als der klassische Weg vor Ort.",
"Viele Fahrzeughalter wählen Auto online abmelden in {{city}}, weil der digitale Start schneller wirkt und sich leicht in einen vollen Alltag einbauen lässt.",
"In {{city}} ist Auto online abmelden besonders hilfreich, wenn die Abmeldung zügig vorbereitet werden soll und kein zusätzlicher Termin gewünscht ist.",
"Wer Auto online abmelden in {{city}} möchte, kann viele Schritte heute deutlich einfacher digital vorbereiten. Genau deshalb wird der Online-Weg so häufig genutzt.",
"Auto online abmelden in {{city}} wird in {{state}} oft gesucht, weil viele den organisatorischen Aufwand klein halten und lieber direkt online starten möchten.",
"Wer sein Auto online abmelden in {{city}} will, erwartet vor allem Klarheit, einfache Schritte und eine Lösung ohne unnötige Wege. Genau dafür ist der digitale Ablauf gedacht.",
"Auto online abmelden in {{city}} ist für viele besonders angenehm, wenn Kennzeichen, Fahrzeugschein und wichtige Daten bereits vorliegen und direkt genutzt werden können.",
"In {{city}} suchen viele nach Auto online abmelden, weil die zuständige Behörde {{behoerde_name}} zwar bekannt ist, der digitale Weg aber oft besser in den Alltag passt.",
"Wer Auto online abmelden in {{city}} eingibt, möchte den Vorgang meist verständlich, schnell und ohne zusätzliche Behördenschritte vorbereiten.",
"Auto online abmelden in {{city}} bedeutet für viele eine flexible Lösung, die ohne Termin beginnt und trotzdem einen klaren Ablauf bietet.",
"In {{city}} ist Auto online abmelden für viele deshalb attraktiv, weil die Abmeldung ruhig digital vorbereitet werden kann und keine zusätzliche Anfahrt nötig ist.",
"Wer sein Fahrzeug online abmelden in {{city}} möchte, sucht oft keinen langen Prozess, sondern einen direkten digitalen Einstieg mit klarer Struktur.",
"Auto online abmelden in {{city}} ist für viele in {{state}} die bequemere Wahl, wenn unnötige Wege, Wartezeiten und feste Termine vermieden werden sollen.",
"Viele Menschen möchten ihr Auto online abmelden in {{city}}, weil der digitale Ablauf besser planbar ist und sich einfacher starten lässt als der klassische Behördengang.",
"Wer in {{city}} Auto online abmelden möchte, kann den Vorgang bequem vorbereiten, ohne extra zu {{behoerde_name}} unter {{behoerde_adresse}} fahren zu müssen.",
"Auto online abmelden in {{city}} wird oft bevorzugt, wenn der Alltag wenig Zeit lässt und die Abmeldung trotzdem schnell und sauber vorbereitet werden soll.",
"In {{city}} ist Auto online abmelden für viele die praktische Alternative, weil der Weg digital beginnt und wichtige Schritte direkt online erledigt werden können.",
"Wer Auto online abmelden in {{city}} sucht, möchte meistens eine einfache Lösung ohne komplizierte Fachsprache. Genau das macht den digitalen Weg so interessant.",
"Auto online abmelden in {{city}} passt für viele besonders gut, wenn das Fahrzeug verkauft wurde und die Abmeldung zeitnah folgen soll.",
"In {{state}} orientieren sich viele Nutzer an Auto online abmelden in {{city}}, weil sie einen digitalen Weg ohne zusätzlichen Besuch bei {{behoerde_name}} bevorzugen.",
"Wer sein Auto online abmelden in {{city}} möchte, profitiert oft davon, dass der Ablauf Schritt für Schritt digital vorbereitet werden kann.",
"Auto online abmelden in {{city}} ist für viele leichter, weil die wichtigsten Angaben gesammelt, geprüft und ohne unnötige Unterbrechung online übermittelt werden können.",
"In {{city}} wird Auto online abmelden immer häufiger genutzt, weil viele Fahrzeughalter den Behördengang sparen und lieber direkt digital starten möchten.",
"Wer Auto online abmelden in {{city}} möchte, möchte oft zuerst wissen, welche Unterlagen nötig sind und wie schnell der Ablauf vorbereitet werden kann.",
"Auto online abmelden in {{city}} ist besonders dann sinnvoll, wenn die Abmeldung ohne klassische Terminlogik und ohne zusätzlichen Organisationsaufwand erfolgen soll.",
"In {{city}} schätzen viele an Auto online abmelden, dass der Vorgang verständlich beginnt und ohne unnötige Zusatzwege vorbereitet werden kann.",
"Wer sein Fahrzeug online abmelden in {{city}} möchte, entscheidet sich oft bewusst für digital, weil der Ablauf ruhiger und planbarer wirkt als vor Ort.",
"Auto online abmelden in {{city}} ist in {{state}} für viele eine überzeugende Lösung, wenn der Vorgang bequem von zu Hause aus gestartet werden soll.",
"Wer in {{city}} nach Auto online abmelden sucht, möchte meist eine zeitsparende Möglichkeit ohne Fahrt zur Zulassungsstelle und ohne unnötige Wartezeit.",
"Auto online abmelden in {{city}} wird von vielen gewählt, weil der Einstieg direkt digital erfolgt und die wichtigsten Schritte klar erkennbar sind.",
"In {{city}} ist Auto online abmelden für viele besonders praktisch, wenn eine verständliche Lösung gesucht wird, die ohne zusätzlichen Vor-Ort-Termin funktioniert.",
"Wer Auto online abmelden in {{city}} möchte, findet hier einen digitalen Weg, der klar aufgebaut ist und für viele besser in den Alltag passt als die klassische Abmeldung vor Ort."
  ...
  "Wer sein Fahrzeug online abmelden möchte, sollte die wichtigsten Unterlagen vor dem Start kurz prüfen.",
  "Vor dem digitalen Start ist ein kurzer Unterlagen-Check sinnvoll. Wichtig sind Kennzeichen, Fahrzeugschein und Sicherheitscodes.",
  "Viele möchten vor dem Start wissen, was sie brauchen. Meist sind Kennzeichen, Fahrzeugschein und Fahrzeugdaten entscheidend.",
  "Damit der Ablauf sauber vorbereitet werden kann, sollten alle wichtigen Angaben vollständig vorliegen.",
  "Je besser die Vorbereitung, desto einfacher wirkt die Online-Abmeldung später.",
  "Viele Fehler entstehen schon vor dem Antrag durch fehlende oder unklare Angaben.",
  "Wer das Auto online abmelden möchte, kommt meist schneller voran, wenn alle Unterlagen bereitliegen.",
  "Vor allem beim ersten Mal hilft eine klare Vorbereitung mit Kennzeichen, Fahrzeugschein und Codes.",
  "Bevor der Vorgang beginnt, sollten die wichtigsten Informationen einmal vollständig geprüft werden.",
  "Die Online-Abmeldung läuft oft entspannter, wenn nichts erst während des Ausfüllens gesucht werden muss.",
  "Viele Nutzer möchten vor dem Start sicher sein, dass alles vorhanden ist. Ein kurzer Check schafft schnell Klarheit.",
  "Damit der digitale Prozess ohne Verzögerung starten kann, sollten alle Angaben lesbar und vollständig sein.",
  "Eine saubere Vorbereitung hilft, spätere Rückfragen und kleine Fehler zu vermeiden.",
  "Wer Kennzeichen, Fahrzeugschein und Fahrzeugdaten vorab bereitlegt, erlebt den Ablauf meist strukturierter.",
  "Vor dem digitalen Antrag hilft es, die wichtigsten Unterlagen an einem Ort zusammenzulegen.",
  "Viele möchten wissen, welche Unterlagen wirklich gebraucht werden. Besonders wichtig sind Kennzeichen und Fahrzeugschein.",
  "Je besser die Unterlagen vorbereitet sind, desto leichter lässt sich das Fahrzeug online abmelden.",
  "Wichtig ist vor allem, dass Kennzeichen und Fahrzeugschein korrekt und gut lesbar vorliegen.",
  "Bevor Sie starten, sollten Fahrzeugschein, Kennzeichen und Sicherheitscodes kurz geprüft werden.",
  "Viele Nutzer wollen vorab wissen, was sie online bereithalten müssen. Genau das spart später Zeit.",
  "Wenn die nötigen Angaben schon vorliegen, läuft die Online-Abmeldung meist deutlich flüssiger.",
  "Vor dem Start hilft eine einfache Checkliste: Kennzeichen, Fahrzeugschein, FIN und Sicherheitscode.",
  "Eine gute Vorbereitung reduziert oft den Stress beim digitalen Ablauf.",
  "Gerade bei der Online-Abmeldung ist Lesbarkeit entscheidend. Unklare Angaben führen schneller zu Rückfragen.",
  "Wer das Fahrzeug online abmelden möchte, sollte Daten am besten direkt aus den Unterlagen übernehmen.",
  "Damit die Abmeldung ohne unnötige Verzögerung vorbereitet werden kann, müssen die wichtigsten Angaben vollständig sein.",
  "Viele Nutzer erleben den digitalen Ablauf als einfacher, wenn die Vorbereitung vorher stimmt.",
  "Vor dem Online-Start lohnt sich eine kurze Prüfung der Fahrzeugdaten.",
  "In {{city}} startet die Online-Abmeldung meist deutlich leichter, wenn Kennzeichen und Fahrzeugschein schon bereitliegen.",
  "Wer die Online-Abmeldung in {{city}} entspannt beginnen möchte, sollte Unterlagen und Fahrzeugdaten vorher kurz prüfen.",
  "Viele Nutzer in {{city}} sparen Zeit, wenn Kennzeichen, Codes und Fahrzeugschein direkt griffbereit sind.",
  "Gerade in {{city}} hilft eine kurze Vorbereitung, damit der digitale Antrag ohne Unterbrechung starten kann.",
  "Bevor Sie Ihr Fahrzeug online abmelden in {{city}}, sollten die wichtigsten Angaben vollständig vorliegen.",
  "In {{city}} wirkt der Ablauf meist deutlich klarer, wenn Unterlagen und Codes vor dem Start geprüft werden.",
  "Wer in {{city}} sein Auto online abmelden möchte, sollte Kennzeichen und Fahrzeugschein zuerst bereitlegen.",
  "In {{state}} achten viele Nutzer darauf, vor dem Start alle wichtigen Unterlagen vollständig vorzubereiten.",
  "Gerade in {{state}} hilft eine saubere Vorbereitung, um Rückfragen und Verzögerungen zu vermeiden.",
  "In {{state}} läuft die Online-Abmeldung oft einfacher, wenn die wichtigsten Angaben schon vor dem ersten Klick bereitliegen.",
  "Viele Nutzer aus {{state}} möchten vor dem Start sicher sein, dass nichts fehlt. Ein kurzer Check hilft sofort.",
  "Wer in {{city}} in {{state}} startet, sollte Kennzeichen, Fahrzeugschein und Codes vorher kurz kontrollieren.",
  "Für {{city}} ist {{behoerde_name}} die bekannte Stelle vor Ort. Online hilft eine gute Vorbereitung, Zeit zu sparen.",
  "Wer in {{city}} sonst zu {{behoerde_name}} müsste, sollte online zuerst alle Unterlagen vollständig bereitlegen.",
  "In {{city}} kennen viele {{behoerde_name}}. Für den Online-Weg sind vor allem klare und vollständige Angaben wichtig.",
  "Vor dem digitalen Start in {{city}} prüfen viele statt {{behoerde_name}} lieber direkt ihre Unterlagen und Codes.",
  "Wer in {{city}} sein Fahrzeug abmelden möchte, sollte die Daten nicht aus dem Kopf, sondern direkt aus den Unterlagen übernehmen.",
  "In {{city}} spart eine gute Vorbereitung oft mehr Zeit als der eigentliche Antrag.",
...
preparationsDistrict: [
 ...
 trust: [
  ...
  "Vertrauen entsteht vor allem dann, wenn der Ablauf klar bleibt und alle wichtigen Angaben einfach erklärt sind.",
  "Viele bevorzugen einen digitalen Weg, der verständlich aufgebaut ist und ohne unnötige Unsicherheit startet.",
  "Einfach erklärte Schritte und ein klarer Ablauf geben vielen Nutzern direkt mehr Sicherheit.",
  "Wer sein Auto online abmelden möchte, erwartet einen klaren Weg statt unnötiger Fachsprache.",
  "Viele Nutzer vertrauen digitalen Lösungen dann, wenn sie sauber geführt werden und nichts unklar bleibt.",
  "Ein verständlicher Antrag schafft Vertrauen, weil jeder Schritt logisch und gut nachvollziehbar bleibt.",
  "Wichtig ist vor allem, dass Kennzeichen, Fahrzeugschein und Codes korrekt und gut lesbar vorliegen.",
  "Viele möchten beim Auto online abmelden nicht rätseln, sondern sicher durch den Ablauf geführt werden.",
  "Ein ruhiger und klarer Ablauf wirkt für viele vertrauenswürdiger als lange Erklärungen.",
  "Vertrauen wächst, wenn Nutzer sofort sehen, was gebraucht wird und wie der Ablauf funktioniert.",
  "Viele empfinden die Online-Abmeldung als sicherer, wenn alle Schritte klar gegliedert sind.",
  "Eine einfache Struktur hilft vielen, den Antrag sicher und ohne Unsicherheit zu starten.",
  "Gerade beim ersten Mal ist ein verständlicher Ablauf der wichtigste Vertrauensfaktor.",
  "Viele Nutzer möchten wissen, dass sie mit klaren Schritten sicher zum Ziel kommen.",
  "Ein digitaler Ablauf wirkt besonders vertrauensvoll, wenn er einfach, logisch und nachvollziehbar bleibt.",
  "Viele Menschen haben keine Sorge vor dem Internet, sondern vor unklaren Formularen.",
  "Wer weiß, was gebraucht wird, fühlt sich bei der Online-Abmeldung meist sofort sicherer.",
  "Ein klarer Antrag ohne unnötige Hürden macht die Online-Abmeldung für viele deutlich angenehmer.",
  "Viele Fahrer möchten ihr Fahrzeug online abmelden, ohne dabei unsicher zu werden.",
  "Eine gute digitale Lösung schafft Vertrauen durch klare Hinweise und einen verständlichen Aufbau.",
  "Viele Nutzer vertrauen einem Prozess dann, wenn nichts überraschend oder unnötig kompliziert wirkt.",
  "Gerade bei der Autoabmeldung zählt Vertrauen oft mehr als lange technische Erklärungen.",
  "Ein sauber geführter Ablauf gibt vielen Menschen direkt ein besseres Gefühl beim Start.",
  "Viele Menschen möchten zuerst sehen, dass die Online-Abmeldung verständlich und ordentlich aufgebaut ist.",
  "Klare Hinweise zu Unterlagen, Kennzeichen und Codes schaffen schnell mehr Sicherheit.",
  "Viele empfinden den digitalen Weg als sicher, wenn sie jederzeit den Überblick behalten.",
  "Ein nachvollziehbarer Ablauf hilft, Fehler zu vermeiden und Vertrauen aufzubauen.",
  "Wer sich beim Antrag nicht verliert, erlebt die Online-Abmeldung meist als deutlich sicherer.",
  "In {{city}} ist für viele wichtig, dass die Online-Abmeldung klar, ruhig und ohne unnötige Hürden startet.",
  "Viele Nutzer aus {{city}} bevorzugen einen digitalen Weg, der verständlich bleibt und sicher vorbereitet werden kann.",
  "Gerade in {{city}} schafft ein klarer Ablauf ohne unnötige Komplikationen deutlich mehr Vertrauen.",
  "Wer in {{city}} sein Auto online abmelden möchte, erwartet vor allem Klarheit und einen sauberen Ablauf.",
  "In {{city}} wirkt die Online-Abmeldung für viele besonders vertrauensvoll, wenn jeder Schritt verständlich bleibt.",
  "Viele Fahrzeughalter in {{city}} möchten einen Weg, der einfach erklärt ist und sicher durch den Antrag führt.",
  "In {{state}} achten viele Nutzer auf eine Lösung, die verständlich, sauber und ohne Druck funktioniert.",
  "Gerade in {{state}} schafft ein klar aufgebauter digitaler Ablauf oft schneller Vertrauen als ein unübersichtlicher Antrag.",
  "Viele Menschen aus {{state}} bevorzugen eine Online-Abmeldung, die klar erklärt ist und ohne unnötige Hürden startet.",
  "In {{state}} gewinnt der digitale Weg Vertrauen, wenn Unterlagen, Angaben und Schritte klar nachvollziehbar bleiben.",
  "Wer in {{city}} in {{state}} sein Fahrzeug abmelden möchte, schätzt vor allem einen verständlichen digitalen Ablauf.",
  "Für viele in {{city}} ist {{region}} die bekannte Stelle vor Ort, der Online-Weg wirkt aber oft klarer und einfacher.",
  "Wer in {{city}} sonst zu {{region}} fahren würde, bevorzugt oft einen digitalen Ablauf mit klaren Schritten.",
  "In {{city}} ist {{region}} vielen bekannt, trotzdem schafft ein gut erklärter Online-Weg oft mehr Vertrauen.",
  "Viele Nutzer aus {{city}} prüfen statt {{region}} lieber direkt die digitale Alternative mit verständlichem Ablauf.",
  "Vor dem Besuch bei {{behoerde_name}} suchen viele in {{city}} zuerst nach einer klaren Online-Lösung.",
  "Wer in {{city}} an {{behoerde_name}} denkt, möchte oft trotzdem lieber einen ruhig erklärten digitalen Weg nutzen.",
...
{ q: "Kann ich mein Auto online abmelden in {{city}}?", a: "Ja, viele Fahrzeughalter in {{city}} nutzen die Online-Abmeldung, weil sie oft einfacher und bequemer ist als ein Termin vor Ort." },
{ q: "Kann ich mein Fahrzeug online abmelden in {{city}}?", a: "Ja, die Online-Abmeldung ist für viele Fahrzeughalter in {{city}} eine praktische Lösung, wenn die Voraussetzungen erfüllt sind." },
{ q: "Kann man ein Auto online abmelden in {{city}}?", a: "Ja, das ist auch in {{city}} möglich, wenn Kennzeichen und Fahrzeugschein die nötigen Sicherheitscodes haben." },
{ q: "Wie kann ich mein Auto online abmelden in {{city}}?", a: "Sie starten den Antrag digital, geben die Fahrzeugdaten ein und prüfen alle Sicherheitscodes sorgfältig vor dem Absenden." },
{ q: "Wie funktioniert Auto online abmelden in {{city}}?", a: "In {{city}} läuft die Online-Abmeldung für viele über einen klaren digitalen Ablauf mit Kennzeichen, Fahrzeugschein und Sicherheitscodes." },
{ q: "Was brauche ich, um mein Auto online abzumelden in {{city}}?", a: "Wichtig sind meist Kennzeichen, Fahrzeugschein, Sicherheitscodes und gut lesbare Fahrzeugdaten." },
{ q: "Welche Unterlagen brauche ich für die Online-Abmeldung in {{city}}?", a: "Für die Online-Abmeldung in {{city}} werden in der Regel Kennzeichen, Zulassungsbescheinigung Teil I und die passenden Sicherheitscodes benötigt." },
{ q: "Brauche ich den Fahrzeugbrief für die Online-Abmeldung in {{city}}?", a: "Meist nicht. Für die Online-Abmeldung wird in der Regel die Zulassungsbescheinigung Teil I benötigt." },
{ q: "Brauche ich den Fahrzeugschein für die Online-Abmeldung in {{city}}?", a: "Ja, der Fahrzeugschein ist für die Online-Abmeldung in {{city}} in der Regel notwendig." },
{ q: "Brauche ich mein Kennzeichen für die Online-Abmeldung in {{city}}?", a: "Ja, die Angaben vom Kennzeichen und die Sicherheitscodes der Plaketten sind meist erforderlich." },
{ q: "Wo finde ich den Sicherheitscode im Fahrzeugschein?", a: "Der Sicherheitscode wird erst nach dem Freilegen sichtbar. Die schon vorher sichtbare Nummer ist nicht der richtige Code." },
{ q: "Wo finde ich den Sicherheitscode am Kennzeichen?", a: "Der Code liegt hinter der Siegelplakette. Vorher sollte geprüft werden, ob rechts neben dem Siegel ein QR-Code sichtbar ist." },
{ q: "Woran erkenne ich, ob mein Kennzeichen onlinefähig ist?", a: "Kennzeichen mit Online-Funktion haben in der Regel einen QR-Code rechts neben dem Siegel." },
{ q: "Was bedeutet es, wenn neben dem Siegel kein QR-Code ist?", a: "Dann hat das Kennzeichen meist keine Online-Funktion und sollte in der Regel nicht freigelegt werden." },
{ q: "Ist für die Online-Abmeldung das Baujahr entscheidend?", a: "Nein. Entscheidend ist nicht das Baujahr, sondern ob das Fahrzeug onlinefähige Unterlagen und Kennzeichen hat." },
{ q: "Kann auch ein altes Auto online abgemeldet werden in {{city}}?", a: "Ja, auch ein älteres Fahrzeug kann in {{city}} online abgemeldet werden, wenn die passenden Codes und Unterlagen vorhanden sind." },
{ q: "Gilt die Online-Abmeldung nur für Fahrzeuge ab Baujahr 2015?", a: "Nein, das ist falsch. Wichtig ist nicht das Baujahr, sondern ob die Zulassung oder Ummeldung mit onlinefähigen Unterlagen erfolgt ist." },
{ q: "Warum finde ich unter dem Siegel keinen Code?", a: "Oft ist das Kennzeichen dann nicht onlinefähig oder es fehlt bereits die passende Online-Funktion." },
{ q: "Warum sehe ich nur 6 Stellen beim Sicherheitscode?", a: "Dann ist der Code nicht vollständig. Für die Online-Abmeldung werden immer 7 Stellen benötigt." },
{ q: "Was soll ich tun, wenn nur 6 Stellen sichtbar sind?", a: "Dann sollte der QR-Code im freigelegten Zustand gescannt werden, damit der vollständige Code korrekt ausgelesen werden kann." },
{ q: "Welche Nummer im Fahrzeugschein ist die richtige?", a: "Für die Online-Abmeldung wird die freigelegte 7-stellige Nummer verwendet, nicht die 8-stellige Nummer." },
{ q: "Wofür ist die 8-stellige Nummer im Fahrzeugschein?", a: "Die 8-stellige Nummer ist nicht der Sicherheitscode für die Online-Abmeldung, sondern für die digitale Einrichtung des Fahrzeugscheins gedacht." },
{ q: "Was ist bei der Abzieh-Variante im Fahrzeugschein wichtig?", a: "Bei der Abzieh-Variante wird die obere 7-stellige Nummer verwendet. Die 8-stellige Nummer ist dafür nicht richtig." },
{ q: "Was ist bei der Rubbel-Variante im Fahrzeugschein wichtig?", a: "Der richtige Sicherheitscode wird erst nach dem Freirubbeln sichtbar. Vorher sichtbare Nummern sind nicht der richtige Code." },
{ q: "Woher weiß ich, ob ich rubbeln oder abziehen muss?", a: "Wenn auf dem grünen Feld kein Pfeil und keine hellgrüne Ecke zu sehen sind, muss gerubbelt werden. Bei hellgrüner Ecke oder Pfeil muss abgezogen werden." },
{ q: "Warum funktioniert die Online-Abmeldung trotz richtiger Eingabe nicht?", a: "In seltenen Fällen liegt das Problem nicht beim Kunden, sondern bei der Behörde oder der Registrierung im System." },
{ q: "Was tun, wenn QR-Code und Sicherheitscode stimmen, aber die Abmeldung nicht klappt?", a: "Dann liegt oft ein behördlicher Sonderfall vor. In solchen Fällen bleibt manchmal nur der Kontakt zu {{behoerde_name}}." },
{ q: "An wen kann ich mich wenden, wenn die Online-Abmeldung in {{city}} nicht funktioniert?", a: "Dann kann eine Rückfrage bei {{behoerde_name}} sinnvoll sein, zum Beispiel unter {{behoerde_telefon}} oder {{behoerde_email}}." },
{ q: "Wo ist die zuständige Zulassungsstelle für {{city}}?", a: "Zuständig ist {{behoerde_name}}, {{behoerde_adresse}}, {{behoerde_plz}} {{behoerde_ort}}." },
{ q: "Kann ich die Zulassungsstelle in {{city}} anrufen, wenn ein Fehler auftaucht?", a: "Ja, bei besonderen Problemen kann eine Rückfrage bei {{behoerde_name}} unter {{behoerde_telefon}} sinnvoll sein." },
{ q: "Kann ich der Zulassungsstelle in {{city}} eine E-Mail senden, wenn online nichts geht?", a: "Ja, in Sonderfällen kann eine Nachricht an {{behoerde_email}} helfen, wenn die Online-Abmeldung nicht möglich ist." },
{ q: "Muss ich zur Zulassungsstelle {{behoerde_name}}, wenn online nichts funktioniert?", a: "Wenn die Codes korrekt sind und die Online-Abmeldung trotzdem scheitert, bleibt manchmal nur der Weg zu {{behoerde_name}}." },
{ q: "Was passiert bei offenen Gebühren oder Rückständen?", a: "In seltenen Fällen blockieren offene Gebühren oder Rückstände die Abmeldung. Dann muss die Forderung zuerst bezahlt werden." },
{ q: "Kann ich mein Auto in {{city}} online abmelden, wenn noch Gebühren offen sind?", a: "Wenn offene Gebühren bestehen, ist die Abmeldung oft erst nach Zahlung möglich." },
{ q: "Kann ich die Online-Abmeldung in {{city}} auch vom Handy aus starten?", a: "Ja, viele Nutzer starten die Online-Abmeldung in {{city}} bequem am Smartphone." },
{ q: "Kann ich die Online-Abmeldung in {{city}} auch am PC machen?", a: "Ja, die Online-Abmeldung kann in {{city}} auch am Computer vorbereitet und ausgefüllt werden." },
{ q: "Ist die Online-Abmeldung in {{city}} auch für Einsteiger geeignet?", a: "Ja, viele Nutzer in {{city}} bevorzugen den digitalen Weg gerade dann, wenn der Ablauf klar und einfach erklärt ist." },
{ q: "Ist die Online-Abmeldung in {{city}} auch für Berufstätige praktisch?", a: "Ja, viele Berufstätige in {{city}} nutzen den digitalen Weg, weil kein Vor-Ort-Termin nötig ist." },
{ q: "Kann auch jemand anders mein Auto online abmelden in {{city}}?", a: "Ja, grundsätzlich ist das oft möglich, wenn alle nötigen Angaben und Unterlagen korrekt vorliegen." },
{ q: "Kann ich ein abgemeldetes Fahrzeug von zu Hause aus außer Betrieb setzen in {{city}}?", a: "Ja, viele Fahrzeughalter in {{city}} nutzen dafür die Online-Abmeldung ohne zusätzlichen Behördengang." },
{ q: "Ist die Online-Abmeldung in {{city}} auch für Motorrad, Anhänger oder LKW möglich?", a: "Ja, je nach Fahrzeugart ist die Online-Abmeldung auch für Motorrad, Anhänger oder LKW möglich, wenn die Voraussetzungen erfüllt sind." },
{ q: "Kann ich auch einen Anhänger online abmelden in {{city}}?", a: "Ja, auch ein Anhänger kann online abgemeldet werden, wenn die passenden Unterlagen und Sicherheitscodes vorhanden sind." },
{ q: "Kann ich auch ein Motorrad online abmelden in {{city}}?", a: "Ja, auch Motorräder können in vielen Fällen online abgemeldet werden, wenn die Voraussetzungen stimmen." },
{ q: "Kann ich auch einen LKW online abmelden in {{city}}?", a: "Ja, auch bei einem LKW ist die Online-Abmeldung möglich, wenn die Unterlagen und Sicherheitscodes passen." },
{ q: "Ist die Online-Abmeldung in {{city}} schneller als vor Ort?", a: "Viele Nutzer in {{city}} empfinden die Online-Abmeldung als schneller und planbarer als einen Termin vor Ort." },
{ q: "Warum bevorzugen viele Menschen in {{city}} die Online-Abmeldung?", a: "Viele bevorzugen den digitalen Weg in {{city}}, weil er bequemer, klarer und oft leichter in den Alltag passt." },
{ q: "Welche Fehler sollte ich vor dem Absenden vermeiden?", a: "Wichtig ist, Kennzeichen, Fahrzeugschein, Sicherheitscodes und Fahrzeugdaten noch einmal genau zu prüfen." },
{ q: "Warum ist eine Endkontrolle vor dem Absenden wichtig?", a: "Schon kleine Fehler bei Buchstaben, Zahlen oder Codes können die Online-Abmeldung unnötig verzögern." },
{ q: "Was soll ich tun, wenn der Code beschädigt oder schlecht lesbar ist?", a: "Dann sollte der QR-Code im freigelegten Zustand geprüft werden, weil damit viele Eingabefehler vermieden werden können." },
{ q: "Was muss ich bei O und 0 oder I (i) und l (L) beachten?", a: "Diese Zeichen werden häufig verwechselt. Deshalb sollten Codes immer sehr genau geprüft oder zusätzlich per QR-Code kontrolliert werden." },
{ q: "Warum sollte ich die freigelegte Folie vom Kennzeichen nicht sofort wegwerfen?", a: "Weil bei übereinander geklebten Siegeln oder unklaren Codes die obere Schicht noch wichtige Hinweise enthalten kann." },
{ q: "Kann ein Kennzeichen trotz neuer Ummeldung noch alte Siegel ohne Online-Funktion haben?", a: "Ja, das ist möglich, wenn bei der Ummeldung alte Kennzeichen übernommen wurden." },
{ q: "Was ist in {{city}} der häufigste Grund, warum die Online-Abmeldung scheitert?", a: "Sehr häufig sind es kleine Fehler bei Sicherheitscodes, unvollständige Codes oder Kennzeichen ohne passende Online-Funktion." },
{ q: "Lohnt sich die Online-Abmeldung in {{city}} auch bei wenig Zeit?", a: "Ja, gerade bei wenig Zeit nutzen viele Fahrzeughalter in {{city}} den digitalen Weg, weil er oft besser planbar ist." },
{ q: "Kann ich mir durch die Online-Abmeldung in {{city}} den Weg zur Behörde sparen?", a: "Ja, genau deshalb nutzen viele Fahrzeughalter in {{city}} die digitale Abmeldung." },
{ q: "Was sollte ich vor dem Start in {{city}} am besten zuerst prüfen?", a: "Am besten zuerst Kennzeichen, Fahrzeugschein, QR-Code und die Sicherheitscodes kontrollieren." },
{ q: "Ist die Online-Abmeldung in {{city}} auch dann sinnvoll, wenn ich Fehler vermeiden will?", a: "Ja, viele Nutzer in {{city}} finden den digitalen Weg gerade dann hilfreich, wenn sie Schritt für Schritt vorgehen möchten." },
{ q: "Wie erreiche ich {{behoerde_name}} bei Problemen mit der Abmeldung?", a: "Sie erreichen {{behoerde_name}} unter {{behoerde_telefon}} oder per E-Mail an {{behoerde_email}}." },
{ q: "Wo finde ich {{behoerde_name}} in der Nähe von {{city}}?", a: "Die zuständige Stelle ist {{behoerde_name}}, {{behoerde_adresse}}, {{behoerde_plz}} {{behoerde_ort}}." },
...
const BEHOERDE_TOKEN_REGEX =
  /\{\{behoerde_(name|adresse|plz|ort|telefon|email)\}\}/;

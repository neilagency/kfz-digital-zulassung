    ...
    '@graph': [
      {
        ...
        logo: {
          '@type': 'ImageObject',
          url: `${settings.siteUrl}/logo.webp`,
        },
      ...
      {
        '@type': 'VideoObject',
        '@id': `${settings.siteUrl}/vedio#video-1`,
        ...
        thumbnailUrl: [
          'https://i.ytimg.com/vi/3nsdJSvKAtE/maxresdefault.jpg',
        ],
        uploadDate: '2026-04-27T08:00:00+02:00',
        embedUrl: 'https://www.youtube-nocookie.com/embed/3nsdJSvKAtE',
        contentUrl: 'https://www.youtube.com/watch?v=3nsdJSvKAtE',
        publisher: {
          '@id': `${settings.siteUrl}/#organization`,
        },
      },
      {
        '@type': 'VideoObject',
        '@id': `${settings.siteUrl}/vedio#video-2`,
        ...
        thumbnailUrl: [
          'https://i.ytimg.com/vi/u38keaF1QKU/maxresdefault.jpg',
        ],
        uploadDate: '2026-04-27T08:00:00+02:00',
        embedUrl: 'https://www.youtube-nocookie.com/embed/u38keaF1QKU',
        contentUrl: 'https://www.youtube.com/watch?v=u38keaF1QKU',
        publisher: {
          '@id': `${settings.siteUrl}/#organization`,
        },
      },
